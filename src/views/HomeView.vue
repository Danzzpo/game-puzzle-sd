...
// --- LOGIC: Cek User & Tema saat Website Dibuka ---
onMounted(() => {
    ...
    <main class="main-content">
      ...
      <section class="how-it-works">
        <div class="section-header">
          <h2>Cara Bermain</h2>
          <p>Hanya 4 langkah mudah untuk memulai puzzle pertamamu</p>
        </div>
        ...
        <div class="steps-grid">
          ...
          <div class="step-card">
            ...
            <p>Mainkan di perangkat apa saja dengan simpan otomatis.</p>
          </div>
          <div class="step-card">
            <div class="step-circle pink">4</div>
            <h3>Menang</h3>
            <p>Selesaikan puzzle dan kumpulkan poinnya.</p>
          </div>
        </div>
      </section>
...
/* NAVBAR */
.navbar { display: flex; justify-content: space-between; align-items: center; padding: 15px 5%; background-color: var(--nav-bg); border-bottom: 1px solid var(--border-color); transition: background-color 0.3s; }
...
.welcome-text { color: var(--text-color); font-size: 14px; margin-right: 10px; }
...
.theme-btn { background: transparent; border: none; cursor: pointer; padding: 5px; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; }
.theme-icon { font-size: 24px; transition: transform 0.4s ease; display: inline-block; line-height: 1; }
...
@media (max-width: 768px) {
  ...
  .nav-center { display: none; } /* Hilangkan menu tengah di HP */
  ...
  .how-it-works, .why-us { padding: 50px 5%; }
}
</style>
